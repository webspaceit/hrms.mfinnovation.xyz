<?php
// ============================================================
// Invoices (Monthly Due / Demand Notes) Page
// ============================================================
...
<div class="filter-bar mb-3 fade-in flex flex-wrap items-center gap-2">
    ...
    <select class="form-select form-select-sm" style="max-width: 170px;" onchange="location='invoices.php?month='+this.value+'&year=<?php echo $year; ?>'">
        <?php for ($m = 1; $m <= 12; $m++): ?>
            <option value="<?php echo $m; ?>" <?php echo $month == $m ? 'selected' : ''; ?>><?php echo monthName($m); ?></option>
        <?php endfor; ?>
    </select>
    <select class="form-select form-select-sm" style="max-width: 130px;" onchange="location='invoices.php?month=<?php echo $month; ?>&year='+this.value">
                                ...
                                <td>
                                    <?php echo actionButtons([
                                        ...
                                        ['label' => t('view_invoice'), 'icon' => 'bi bi-eye', 'variant' => 'view',
                                         'href' => BASE_URL . 'invoice_view.php?id=' . (int)$inv['id'] . '&lang=' . Lang::current()],
