...
// A bilingual front door for the RMS: brand + feature highlights
// and two login gates. Logged-in users are sent straight to
// their dashboard (admin or tenant portal).
// ============================================================

require_once __DIR__ . '/classes/init.php';

// Per-request language override: index.php?lang=bn
if (isset($_GET['lang'])) {
...
// Available flats & shops for rent (public showcase)
$flatModel = new Flat();
        ...
        <div class="max-w-5xl mx-auto px-4 py-16 md:py-20 text-center">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-5 max-w-2xl mx-auto text-left">
                <div class="landing-card bg-white rounded-2xl p-6 text-slate-800">
                    ...
                    <a href="<?php echo BASE_URL; ?>login.php" class="btn btn-success btn-lg w-100">
                ...
                <div class="landing-card bg-white rounded-2xl p-6 text-slate-800">
                    ...
                    <a href="<?php echo BASE_URL; ?>tenant_login.php" class="btn btn-outline-success btn-lg w-100">
