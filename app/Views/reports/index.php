<?php
// Reports view - data: year, monthlyIncome, monthlyExpense,
// yearlyIncome, yearlyExpense, yearlyProfit, perBuilding
$pageTitle = t('reports');
...
<div class="flex flex-wrap items-center justify-between gap-2 mb-4 fade-in">
    ...
    <div>
        <div class="input-group input-group-sm">
            ...
            <select class="form-select form-select-sm" onchange="location='<?php echo url('reports'); ?>?lang=<?php echo Lang::current(); ?>&year='+this.value">
