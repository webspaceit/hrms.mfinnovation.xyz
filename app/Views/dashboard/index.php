<?php
// Dashboard view - data: stats, chartData, recentPayments, availableFlatsList, ...
    ...
    <div class="lg:col-span-7">
        <div class="card">
            <div class="card-header flex items-center justify-between">
                ...
                <a href="<?php echo url('payments'); ?>" class="btn btn-sm btn-outline-primary"><?php echo t('view'); ?> <i class="bi bi-arrow-right ml-1"></i></a>
            </div>
    ...
    <div class="lg:col-span-5">
        <div class="card h-full">
            <div class="card-header flex items-center justify-between">
                ...
                <a href="<?php echo url('flats'); ?>" class="btn btn-sm btn-outline-success"><?php echo t('view'); ?> <i class="bi bi-arrow-right ml-1"></i></a>
            </div>
            <div class="card-body p-0">
                <div class="table-responsive">
                    <table class="table table-hover table-sm">
    ...
    if (statusCtx) {
        new Chart(statusCtx, {
            ...
            data: {
                labels: statusLabels,
                datasets: [{
                    data: [' . (int)$occupiedFlats . ', ' . (int)$availableFlats . ', ' . (int)$maintenanceCount . '],
