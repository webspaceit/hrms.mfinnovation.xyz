<?php
// Invoice (Demand Note) view - printable + sendable (WhatsApp / Email / SMS).
...
function sendInvoice(id, channel) {
    fetch(' . json_encode(BASE_URL . 'ajax/invoice_send.php') . ', {
        method: "POST",
...
function markInvoicePaid(id) {
    ...
    fetch(' . json_encode(BASE_URL . 'ajax/invoice_status.php') . ', {
        method: "POST",
        headers: { "Content-Type": "application/x-www-form-urlencoded" },
