<?php $pageTitle = t('my_home'); require dirname(__DIR__) . '/partials/tenant_header.php'; ?>
...
<div class="card fade-in mb-4">
    <div class="card-body">
        <div class="flex flex-wrap items-center justify-between gap-2 mb-3">
            ...
            <a href="<?php echo url('tenant-invoice-view'); ?>?id=<?php echo (int)$currentInvoice['id']; ?>" class="btn btn-sm btn-outline-primary">
...
<div class="card fade-in">
    <div class="card-body">
        <div class="flex flex-wrap items-center justify-between gap-2 mb-3">
            ...
            <a href="<?php echo url('tenant-payments') . $langSuffix; ?>" class="btn btn-sm btn-outline-primary">
